                    ...
                    if msg_type == "HANDSHAKE_RESULT":
                        ...
                        if payload.get("type") == "DELEGATION_REQUEST":
                            ...
                            final_query_text = (
                                ...
                                "INSTRUCTION: Process this request using your specialized medical tools. "
                                "In your response, LIST which tools you called (e.g., 'Tools used: dispatch_ambulances, triage_casualties'). "
                            ...
                            final_query_text = (
                                ...
                                "INSTRUCTION: Execute the necessary action immediately (e.g., triage_casualties, dispatch_ambulances). "
                                "Then, you MUST call 'confirm_support_request' to notify the sender."
                            )
