...
logger = logging.getLogger("utility-executor")
a2a = GlobalA2AClient()

class UtilityExecutor(AgentExecutor):
    def __init__(self):
        # Single shared runner instance for all requests
        self.runner = InMemoryRunner(utility_agent)
                    ...
                    if msg_type == "HANDSHAKE_RESULT":
                        ...
                        if payload.get("type") == "DELEGATION_REQUEST":
                            ...
                            final_query_text = (
                                ...
                                "INSTRUCTION: Process this request using your specialized utility tools. "
                                "In your response, LIST which tools you called (e.g., 'Tools used: cut_gas_supply, shutdown_power_grid'). "
                            ...
                            final_query_text = (
                                ...
                                "INSTRUCTION: Execute the necessary action immediately (e.g., shutdown_power_grid, cut_gas_supply). "
