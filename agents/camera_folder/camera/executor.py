...
logger = logging.getLogger("camera-executor")
a2a = GlobalA2AClient()

class CameraAgentExecutor(AgentExecutor):
    def __init__(self):
        # Single shared runner instance for all requests
        self.runner = InMemoryRunner(camera_agent)
                ...
                if isinstance(data, dict):
                    ...
                    if msg_type == "HANDSHAKE_RESULT":
                        ...
                        final_query_text = (
                            ...
                            "INSTRUCTION: Execute the necessary action immediately (e.g., analyze_feed). "
